...
namespace DF2DAnalysis.Frm
{
    public class FrmSectionAnalysis : XtraForm
    {
        ...
        public void SetInfo(string mapname, string mapnum, List<PPLine2D> pplines, double hmax, double hmin, double distsum, string roadname)
        {
