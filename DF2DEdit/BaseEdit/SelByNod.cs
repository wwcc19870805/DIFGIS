...
namespace DF2DEdit.BaseEdit
{
	...
	/// SelByNod 的摘要说明。
	/// </summary>
    public class cmdSelByNod : AbstractMap2DCommand
	{
        ...
        public override void OnMouseDown(int button, int shift, int x, int y, double mapX, double mapY)
        {
            if (button==1)
            {
                ...
                IGeometry pGeoSel = Class.Common.DoBuffer(searchPoint, dis);
                ...
                pFeaSel.SelectFeatures(pSpaFilter, pFeaSel.CombinationMethod, true);
                //m_ActiveView.FocusMap.SelectByShape(Class.Common.DoBuffer(searchPoint, dis), Class.SelectionEnv.System_Selection_Environment(m_ActiveView), false);
