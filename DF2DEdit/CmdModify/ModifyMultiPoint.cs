    /*----------------------------------------------------------------
                ...
                // 版权所有。 
                //
                // 文件名：ModifyMultiPoint.cs
                // 文件功能描述：修改多点类型图层要素的几何信息
                //
                // 
                // 创建标识：高攀20051230
                //
...
{
	/// <summary>
	/// ModifyMultiPoint 的摘要说明。
	/// </summary>
    public class ModifyMultiPoint : IUpdatePoint, IModifyGeometry
    {
        public ModifyMultiPoint()
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void UpdatePoint(int partIndex, int pointIndex, IPoint newPoint)
        {
            ...
            if (newPoint!=null)
            {
                ...
                if ((pointIndex > -1) && (pointIndex < pColl.PointCount) && pColl.PointCount > 0 )
                {
        ...
        public void InsertPoint(int partIndex, int pointIndex, IPoint newPoint)
        {
            ...
            {
                pColl.InsertPoints(partIndex,1,ref newPoint);
