/*----------------------------------------------------------------------------------------
			...
			//
			// 文件名：DrawCircle3P.cs
			// 文件功能描述：给定圆周上的三点 p1+p2+p3，绘制圆\圆形区域
			//
			// 
...
namespace WSGRI.DigitalFactory.DFEditorTool
{
	...
	{		
		...
		private string	strCaption  = "给定圆周上的三点，绘制圆/圆形区域";
        ...
        {
            // TODO:  添加 DrawCircle3P.UnExecute 实现
...
　　　　　　            //计算圆心坐标
        ...
        {
            // TODO:  添加 DrawCircle3P.OnBeforeScreenDraw 实现
