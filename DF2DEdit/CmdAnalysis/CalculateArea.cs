...
namespace WSGRI.DigitalFactory.DFEditorTool
{
    ...
    public class CalculateArea : AbstractMapCommand
    {
        ...
        private string strCaption = "计算面积";
        ...
        public override void OnMouseMove(int button, int shift, int x, int y, double mapX, double mapY)
        {
            ...
            m_pStatusBarService.SetStateMessage("最后一条边的边长:" + m_dblDistance.ToString(".###") + "米");
        ...
        public void EndCalculateArea()
        {
            ...
            if (m_bInUse)
            {
                ...
                {
                    MessageBox.Show("计算面积必须有三个或三个以上的点!");
                }
                else
                {
                    pGeom = (IGeometry)pPointCollection;
                ...
                result = MessageBox.Show("面积为:" + ((IArea)pPolygon).Area.ToString(".###") + "平方米" + CRLF + "周长为:" + pPolygon.Length.ToString(".###") + "米", "面积计算", MessageBoxButtons.OK, MessageBoxIcon.Information);
