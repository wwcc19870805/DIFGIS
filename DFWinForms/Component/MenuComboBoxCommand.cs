...
{
    public class MenuComboBoxCommand : BarEditItem, IStatusUpdate
    {
        private object caller;
        private Codon codon;
        private ICommand menuCommand;
        private RepositoryItemComboBox repositoryItemComboBoxEdit;
        ...
        public MenuComboBoxCommand(Codon codon, object caller)
            : this(codon, caller, false)
        {
        }
        public MenuComboBoxCommand(Codon codon, object caller, bool createCommand)
		{
			this.repositoryItemComboBoxEdit = new RepositoryItemComboBox();
            this.repositoryItemComboBoxEdit.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			this.caller = caller;
			this.codon = codon;
			base.Edit = this.repositoryItemComboBoxEdit;
			base.Name = codon.Id;
			this.repositoryItemComboBoxEdit.SelectedIndexChanged +=new EventHandler(repositoryItemComboBoxEdit_SelectedIndexChanged);
            this.UpdateText();
            if (createCommand)
			{
				this.CreateCommand();
        ...
        public MenuComboBoxCommand(string label)
		{
            this.repositoryItemComboBoxEdit = new RepositoryItemComboBox();
            this.repositoryItemComboBoxEdit.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
            this.codon = null;
        ...
        private void repositoryItemComboBoxEdit_SelectedIndexChanged(object sender, EventArgs e)
        {
