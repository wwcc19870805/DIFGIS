...
{
    public class FormAdd3DTile : XtraForm
    {
        ...
        private void sbtn_Browser_Click(object sender, EventArgs e)
        {
            ...
            dlg.Filter = "3DTile File(*.tdb)|*.tdb";
            dlg.DefaultExt = ".tdb";
        ...
        private void sbtn_OK_Click(object sender, EventArgs e)
        {
            switch (this.radioGroup1.SelectedIndex)
            {
                case 0:
                    ...
                    this.treeNodeName = System.IO.Path.GetFileNameWithoutExtension(this._connInfo);
                    break;
                case 1:
                    ...
                    this.treeNodeName = this.te_DataSource.Text;
                    break;
            }
