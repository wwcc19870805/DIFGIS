...
{
    public class FrmAddPolyline : XtraForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "FrmAddPolyline";
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "线";
            this.TopMost = true;
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FrmAddPolyline_FormClosed);
            this.Load += new System.EventHandler(this.FrmAddPolyline_Load);
        ...
        private void FrmAddPolyline_Load(object sender, EventArgs e)
        {
        ...
        private void FrmAddPolyline_FormClosed(object sender, FormClosedEventArgs e)
        {
            Clear();
            if (this._drawTool != null)
            {
        ...
        private void AddRecord()
        {
            try
            {
                ...
                for (int i = 0; i < line.PointCount; i++)
                {
                    ...
                    if (fiGeo.GeometryDef.HasZ) pttemp.SetCoords(ptGet.X, ptGet.Y, ptGet.Z, 0, 0);
