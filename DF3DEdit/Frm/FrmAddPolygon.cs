...
{
    public class FrmAddPolygon : XtraForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "FrmAddPolygon";
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "面";
            this.TopMost = true;
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FrmAddPolygon_FormClosed);
            this.Load += new System.EventHandler(this.FrmAddPolygon_Load);
        ...
        private void FrmAddPolygon_FormClosed(object sender, FormClosedEventArgs e)
        {
            Clear();
            if (this._drawTool != null)
            {
