...
{
    public class FrmAddPipeLine : XtraForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAddPipeLine));
            ...
            this.Text = "管线";
            this.TopMost = true;
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FrmAddPipeLine_FormClosed);
        ...
        private void FrmAddPipeLine_FormClosed(object sender, FormClosedEventArgs e)
        {
            Clear();
            if (this._drawTool != null)
            {
        ...
        private void AddRecord()
        {
            try
            {
                ...
                if (geo.GeometryType != gviGeometryType.gviGeometryPolyline) return;
        ...
        private bool ValidateDiameter(string str)
        {
            try
            {
                int dia = -1;
                if (int.TryParse(str, out dia)) return true;
                ...
                string arr2 = arr[1];
                int dia1 = -1;
                if (!int.TryParse(arr1, out dia1)) return false;
                int dia2 = -1;
                if (!int.TryParse(arr2, out dia2)) return false;
                return true;
            }
            catch (Exception ex) 
            {
