...
{
    public class FrmAddPipeBuild : XtraForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmAddPipeBuild));
            ...
            this.Name = "FrmAddPipeBuild";
            this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
            this.Text = "辅助";
            this.TopMost = true;
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FrmAddPipeBuild_FormClosed);
            this.Load += new System.EventHandler(this.FrmAddPipeBuild_Load);
        ...
        private void FrmAddPipeBuild_Load(object sender, EventArgs e)
        {
            ...
            string facType = reg.FacilityType.Name;
            if (facType == "PipeBuild") _drawType = DrawType.Polyline;
            else if (facType == "PipeBuild1") _drawType = DrawType.Polygon;
            if (_drawType == DrawType.None) return;
        ...
        private void FrmAddPipeBuild_FormClosed(object sender, FormClosedEventArgs e)
        {
            Clear();
            if (this._drawTool != null)
            {
        ...
        private void AddRecord()
        {
            try
            {
                ...
                if (geo.GeometryType != gviGeometryType.gviGeometryPolygon) return;
                ...
                if (this._drawType == DrawType.Polyline)
                {
                    ...
                    for (int i = 0; i < polygon.ExteriorRing.PointCount; i++)
                    {
                        ...
                        if (fiShape.GeometryDef.HasZ) pttemp.SetCoords(ptGet.X, ptGet.Y, ptGet.Z, 0, 0);
                        else pttemp.SetCoords(ptGet.X, ptGet.Y, 0, 0, 0);
