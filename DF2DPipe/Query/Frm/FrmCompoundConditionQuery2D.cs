...
{
    public class FrmCompoundConditionQuery2D : XtraForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmCompoundConditionQuery2D));
            ...
            // 
            // FrmCompoundConditionQuery2D
            // 
            this.CancelButton = this.btnCancel;
            this.ClientSize = new System.Drawing.Size(506, 443);
            this.Controls.Add(this.layoutControl1);
            this.Name = "FrmCompoundConditionQuery2D";
        ...
        public FrmCompoundConditionQuery2D()
        {
            InitializeComponent();
        }
        ...
        private void FrmCompoundConditionQuery_Load(object sender, EventArgs e)
        {
            ...
            if (this.radioGroup1.SelectedIndex == 0)
            {
                ...
                {
                    ESRI.ArcGIS.Geodatabase.IFeatureClass fc = dffc.GetFeatureClass();
                    if (fc == null) continue;
        ...
        private void DoQuery()
        {
            ...
            if (this.selectFeatureClass != null )
            {
                foreach (DF2DFeatureClass dffc in selectFeatureClass)
                {
                    ...
                    DataTable dt = query.DoQuery(whereClause , dffc);
