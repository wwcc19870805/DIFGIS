    ...
    public class FrmCompoundConditionQuery : XtraForm
    {
                ...
                foreach (TreeListNode node in this.treelist.GetAllCheckedNodes())
                {
                    ...
                    if (obj != null && obj is SubClass)
                    {
                        ...
                        foreach (string fc2DId in arrFc2DId)
                        {
                            ...
                            {
                                pQueryFilter.WhereClause = UpOrDown.DecorateWhereClasuse(fc) + sc.Parent.ClassifyField + " = " + "'" + sc.Name + "'" + " and (" + this.teExpression.Text + ")";
                            ...
                            try
                            {
                                ...
                                pFeatureCursor = fc.Search(pQueryFilter, true);
                ...
                foreach (TreeListNode node in this.treelist.GetAllCheckedNodes())
                {
                    ...
                    if (obj != null && obj is SubClass)
                    {
                        ...
                        foreach (string fc2DId in arrFc2DId)
                        {
                            ...
                            pSpatialFilter.Geometry = this._geo;
                            ...
                            {
                                pSpatialFilter.WhereClause = UpOrDown.DecorateWhereClasuse(fc) + sc.Parent.ClassifyField + " = " + "'" + sc.Name + "'" + " and (" + this.teExpression.Text + ")";
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this._geo == null) DoQuery();
                else DoQueryBySpatial();
