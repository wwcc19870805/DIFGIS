...
{
    class CmdCompoundConditionQuery : AbstractMap2DCommand
    {
        ...
        {
            DF2DPipe.Query.Frm.FrmCompoundConditionQuery dialog = new DF2DPipe.Query.Frm.FrmCompoundConditionQuery();
