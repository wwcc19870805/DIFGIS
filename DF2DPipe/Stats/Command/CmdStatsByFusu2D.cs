...
{
    class CmdStatsByFusu2D : AbstractMap2DCommand
    {
        ...
        {
            bool isNode = true;
            FrmPropertyStats2D dialog = new FrmPropertyStats2D(this.CommandName, "Additional", isNode);
            if (dialog.ShowDialog() != System.Windows.Forms.DialogResult.OK) return;
            //DataTable dt = dialog.DTTemp;
            //DataTable dtstats = dialog.DTStats;
            ////string chartTitle = "管线材质统计图" + " 单位：米";
            //FrmPipeNodeStatsOutput dialog1 = new FrmPipeNodeStatsOutput();
            //dialog1.SetData(dt);
