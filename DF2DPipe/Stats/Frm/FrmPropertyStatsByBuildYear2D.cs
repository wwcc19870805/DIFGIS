...
{
    public partial class FrmPropertyStatsByBuildYear2D : XtraForm
    {
        ...
        public FrmPropertyStatsByBuildYear2D(string title,  string facType)
        {
            InitializeComponent();
            this.Text = title;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmPropertyStatsByBuildYear2D));
            ...
            // 
            // FrmPropertyStatsByBuildYear2D
            // 
            this.CancelButton = this.btnCancel;
            this.ClientSize = new System.Drawing.Size(419, 417);
            this.Controls.Add(this.layoutControl1);
            this.MinimizeBox = false;
            this.Name = "FrmPropertyStatsByBuildYear2D";
            this.ShowIcon = false;
            ...
            foreach (TreeListNode node in list)
            {
                 ...
                 if (obj != null && obj is SubClass)
                 {
                     ...
                     foreach (string fc2DId in arrFc2DId)
                     {
                         ...
                         DFDataConfig.Class.FieldInfo fi1 = facc.GetFieldInfoBySystemName("BuildYear");
                         DFDataConfig.Class.FieldInfo fiPipeLength = facc.GetFieldInfoBySystemName("PipeLength2D");
                         if (fi1 == null  || fiPipeLength == null) continue;
