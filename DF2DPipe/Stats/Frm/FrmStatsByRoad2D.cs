...
{
    public partial class FrmStatsByRoad2D : XtraForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmStatsByRoad2D));
        ...
        public FrmStatsByRoad2D(string title, string sysFieldName)
        {
            InitializeComponent();
            this.Text = title;
        ...
        private void FrmStatsByRoad2D_Load(object sender, EventArgs e)
        {
            BuildTree();
        }
