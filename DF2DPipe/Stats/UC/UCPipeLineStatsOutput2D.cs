...
{
    public partial class UCPipeLineStatsOutput2D : XtraUserControl
    {
        ...
        public UCPipeLineStatsOutput2D()
        {
            InitializeComponent();
            _dt = new DataTable();
            _dtstats = new DataTable();
        }
        public UCPipeLineStatsOutput2D(DataTable dt)
        {
            InitializeComponent();
            _dt = new DataTable();
            _dtstats = new DataTable();
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // UCPipeLineStatsOutput2D
            // 
            this.Controls.Add(this.layoutControl1);
            this.Name = "UCPipeLineStatsOutput2D";
