...
{
    public class UCLocByAddress : XtraUserControl
    {
        ...
        public UCLocByAddress()
        {
            ...
            List<DF3DFeatureClass> list = Dictionary3DTable.Instance.GetFeatureClassByFacilityClassName(new string[] { "GateNO" });
