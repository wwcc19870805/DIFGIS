...
{
    public class CmdViewshedAnalyse : AbstractMap3DCommand
    {
        private DockPanel _dockPanel;
        private int _height = 600;
        private UIDockPanel _uPanel;
        private int _width = 200;
        private UCViewshedAnalyse _uc;
        public override void Run(object sender, System.EventArgs e)
        {
            try
            {
                Map3DCommandManager.Push(this);
                this._uPanel = new UIDockPanel("视域分析", "视域分析", this.Location, this._width, this._height);
                ...
                this._uc = new UCViewshedAnalyse();
