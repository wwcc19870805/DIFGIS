...
{
    public class CmdAlongRoadVisibility : AbstractMap3DCommand
    {
        private DockPanel _dockPanel;
        private int _height = 600;
        private UIDockPanel _uPanel;
        private int _width = 200;
        private UCAlongRoadVisibility _uc;
        public override void Run(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                this._uPanel = new UIDockPanel("沿路通视", "沿路通视", this.Location, this._width, this._height);
                ...
                this._uc = new UCAlongRoadVisibility();
