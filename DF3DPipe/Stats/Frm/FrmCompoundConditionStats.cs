...
{
    public class FrmCompoundConditionStats : XtraForm
    {
        ...
        public FrmCompoundConditionStats()
        {
            InitializeComponent();
        }
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmCompoundConditionStats));
            ...
            this.btnGreaterEqual.TabIndex = 9;
            ...
            this.cbClassifyProperty.TabIndex = 4;
            ...
            this.listBoxControlValues.TabIndex = 6;
            ...
            this.listBoxControlProperty.TabIndex = 5;
                ...
                foreach (TreeListNode node in this.treelist.GetAllCheckedNodes())
                {
                    ...
                    if (obj != null && obj is SubClass)
                    {
                        ...
                        foreach (string fc3DId in arrFc3DId)
                        {
                            ...
                            int index = fc.GetFields().IndexOf(this._classifyField.Name);
                            if (index == -1) continue;
                            IFieldInfo fcfi = fc.GetFields().Get(index);
                            if (fcfi == null) continue;
                            IQueryFilter filter = new QueryFilter();
                            foreach (string strValue in hsValues)
                            {
                                ...
                                {
                                    filter.WhereClause = "GroupId = " + sc.GroupId + " and " + this._classifyField.Name + " = " + strValue;
                                }
                                else
                                {
                                    filter.WhereClause = "GroupId = " + sc.GroupId + " and " + this._classifyField.Name + " = " + strValue + " and (" + this.teExpression.Text + ")";
                                }
                                ...
                                for (int k = 1; k <= loop; k++)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        while ((row = cursor.NextRow()) != null)
                                        {
                                            ...
                                            if ((this._geo as IRelationalOperator2D).Contains2D(modelPoint))
                                            {
                                                if (!row.IsNull(0))
                                                {
                                                    object tempobj = row.GetValue(0);
                ...
                foreach (TreeListNode node in this.treelist.GetAllCheckedNodes())
                {
                    ...
                    if (obj != null && obj is SubClass)
                    {
                        ...
                        foreach (string fc3DId in arrFc3DId)
                        {
                            ...
                            int index = fc.GetFields().IndexOf(this._classifyField.Name);
                            int geometryIndex = fc.GetFields().IndexOf("Geometry");
                            if (index == -1 || geometryIndex == -1) continue;
                            ...
                            foreach (string strValue in hsValues)
                            {
                                ...
                                if (bHave)
                                {
                                    ...
                                    dr["FIELDNAME"] = this._classifyField;
                                    dr["PVALUE"] = strValue;
                                    subclassnumber += subfieldcount;
                                    dr["NUMBER"] = subfieldcount;
                                    dtResult.Rows.Add(dr);
                                }
                            }
                        }
