...
{
    public class FrmPropertyStatsByBuildYear : XtraForm
    {
        ...
        public FrmPropertyStatsByBuildYear(string title,  string facType)
        {
            InitializeComponent();
            this.Text = title;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmPropertyStatsByBuildYear));
            ...
            // 
            // FrmPropertyStatsByBuildYear
            // 
            this.CancelButton = this.btnCancel;
            this.ClientSize = new System.Drawing.Size(419, 417);
            this.Controls.Add(this.layoutControl1);
            this.MinimizeBox = false;
            this.Name = "FrmPropertyStatsByBuildYear";
            this.ShowIcon = false;
                ...
                if (obj != null && obj is SubClass)
                {
                    ...
                    foreach (string fc3DId in arrFc3DId)
                    {
                        ...
                        foreach (DataRow dr1 in this._dt.Rows)
                        {
                            ...
                            filter.WhereClause = "GroupId = " + sc.GroupId + " and ( " + fcfiStartDepth.Name + " >= '" + mind + "' and " + fcfiStartDepth.Name + " <= '" + maxd + "' )";
