...
{
    public class FrmPropertyStatsByDepth : XtraForm
    {
        ...
        public FrmPropertyStatsByDepth(string title,  string facType)
        {
            InitializeComponent();
            this.Text = title;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmPropertyStatsByDepth));
            ...
            foreach (TreeListNode node in list)
            {
                ...
                if (obj != null && obj is SubClass)
                {
                    ...
                    foreach (string fc3DId in arrFc3DId)
                    {
                        ...
                        int indexEndDepth = fc.GetFields().IndexOf(fiEndDepth.Name);
                        ...
                        IFieldInfo fcfiEndDepth = fc.GetFields().Get(indexEndDepth);
                        switch (fcfiEndDepth.FieldType)
                        {
                            case gviFieldType.gviFieldBlob:
                            case gviFieldType.gviFieldGeometry:
                            case gviFieldType.gviFieldUnknown:
                        ...
                        foreach (DataRow dr1 in this._dt.Rows)
                        {
                            ...
                            filter.WhereClause = "GroupId = " + sc.GroupId + " and ( " + fcfiStartDepth.Name + " >= " + mind + " and " + fcfiStartDepth.Name + " <= " + maxd
                                + " and " + fcfiEndDepth.Name + " >= " + mind + " and " + fcfiEndDepth.Name + " <= " + maxd + " )";
