...
{
    public class FrmPropertyQueryByBuildYear : XtraForm
    {
        ...
        public FrmPropertyQueryByBuildYear(string title,  string facType)
        {
            InitializeComponent();
            this.Text = title;
            ...
            int year = time.Year;
            this.spMaxDepth.Value = year;
            this.spMinDepth.Value = year - 10;
        }

        private void InitializeComponent()
        {
            this.components = new System.ComponentModel.Container();
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmPropertyQueryByBuildYear));
            ...
            0,
            0});
            this.spMaxDepth.Location = new System.Drawing.Point(261, 119);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.spMaxDepth.Properties.IsFloatValue = false;
            this.spMaxDepth.Properties.Mask.EditMask = "N00";
            this.spMaxDepth.Size = new System.Drawing.Size(153, 22);
            this.spMaxDepth.StyleController = this.layoutControl1;
            this.spMaxDepth.TabIndex = 4;
            // 
            // spMinDepth
            // 
            ...
            0,
            0});
            this.spMinDepth.Location = new System.Drawing.Point(261, 93);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.spMinDepth.Properties.IsFloatValue = false;
            this.spMinDepth.Properties.Mask.EditMask = "N00";
            this.spMinDepth.Size = new System.Drawing.Size(153, 22);
            this.spMinDepth.StyleController = this.layoutControl1;
            this.spMinDepth.TabIndex = 3;
            // 
            // btnUnSelectAll
            // 
            ...
            this.layoutControlItem5.Text = "起始年代：";
            ...
            this.layoutControlItem6.Text = "终止年代：";
            ...
            // 
            // FrmPropertyQueryByBuildYear
            // 
            this.CancelButton = this.btnCancel;
            this.ClientSize = new System.Drawing.Size(419, 417);
            this.Controls.Add(this.layoutControl1);
            this.MinimizeBox = false;
            this.Name = "FrmPropertyQueryByBuildYear";
            this.ShowIcon = false;
            ...
            foreach (TreeListNode node in list)
            {
                ...
                if (obj != null && obj is SubClass)
                {
                    ...
                    foreach (string fc3DId in arrFc3DId)
                    {
                        ...
                        if (fiStartDepth == null) continue;
                        int indexStartDepth = fc.GetFields().IndexOf(fiStartDepth.Name);
                        if (indexStartDepth == -1) continue;
                        ...
                        if (this._dt.Rows.Count == 0) whereCluase = "GroupId = " + sc.GroupId;
                        else whereCluase = "GroupId = " + sc.GroupId + " and (" + whereCluase.Substring(0, whereCluase.Length - 4) + ")";
        ...
        private void btnAddRow_Click(object sender, EventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("起始年代不能大于终止年代", "提示");
                return;
            }
