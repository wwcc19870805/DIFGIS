...
namespace DF3DPipe.Query.Frm
{
    public class FrmSimpleConditionQuery : XtraForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cbValue.Properties.NullValuePrompt = "(请输入一个属性值)";
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.cbProperty.Properties.NullValuePrompt = "(请选择一个查询属性)";
            ...
            this.layoutControlGroup3.Text = "图层树";
            // 
            // layoutControlItem2
            // 
                ...
                foreach (TreeListNode node in this.treelist.GetAllCheckedNodes())
                {
                    ...
                    if (obj != null && obj is SubClass)
                    {
                        ...
                        foreach (string fc3DId in arrFc3DId)
                        {
                            ...
                            //this._facType = this.radioGroup1.SelectedIndex == 0 ? "PipeLine" : "PipeNode";
                            ...
                            string strWhereClause = "GroupId = " + sc.GroupId + " and " + fi.Name + " " + oper + " " + value;
