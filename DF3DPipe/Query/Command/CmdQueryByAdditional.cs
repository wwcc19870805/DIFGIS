...
{
    public class CmdQueryByAdditional : AbstractMap3DCommand
    {
        ...
        {
            FrmPropertyQuery dialog = new FrmPropertyQuery(this.CommandName, "Additional", "PipeNode");
            ...
            this._uc.SetPropertyInfo(dialog.Dict, "PipeNode");
        }
