...
{
    public class LogicDataStructureManage3D 
    {
        private static LogicDataStructureManage3D instance = null;
        ...
        private LogicDataStructureManage3D()
        {
        ...
        private void ReadConfig()
        {
            try
            {
                string xmlFilePath = Config.GetConfigValue("LogicDataStructureXmlPath3D");
        ...
        public static LogicDataStructureManage3D Instance
        {
            get
            {
                if (LogicDataStructureManage3D.instance == null)
                {
                    lock (syncRoot)
                    {
                        if (LogicDataStructureManage3D.instance == null)
                        {
                            LogicDataStructureManage3D.instance = new LogicDataStructureManage3D();
                        }
                    }
                }
                return LogicDataStructureManage3D.instance;
            }
        }
        ...
        public MajorClass GetMajorClassByDFFeatureClassID(string id)
        {
            ...
            foreach (MajorClass mc in this._allMajorClass)
            {
                if (mc.Fc3D.Contains(id)) return mc;
